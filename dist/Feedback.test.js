...
var submitFeedback = _vitest.vitest.fn(function (helpful) {
...
var mockContextValue = {
  ...
  searchResults: [],
  state: 'indeterminate',
  abort: _vitest.vitest.fn(),
  submitFeedback: submitFeedback,
  setActiveView: _vitest.vitest.fn(),
  setPrompt: _vitest.vitest.fn(),
  setSearchQuery: _vitest.vitest.fn(),
  submitPrompt: _vitest.vitest.fn(),
  submitSearchQuery: _vitest.vitest.fn(),
  updateActiveSearchResult: _vitest.vitest.fn(),
  updatePrompt: _vitest.vitest.fn()
};
(0, _vitest.describe)('Feedback', function () {
  ...
  (0, _vitest.test)('thank the user when feedback was provided', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var user, buttons, yesButton;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          return (0, _react.waitFor)(function () {
            return (0, _vitest.expect)(submitFeedback).toHaveBeenCalledWith(true);
          });
        case 9:
          (0, _vitest.expect)(_react.screen.getByText(/Thank you!/)).toBeInTheDocument();
        case 10:
        case "end":
