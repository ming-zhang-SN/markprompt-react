        ...
        <>
          {trigger?.floating !== false ? (
            <BaseMarkprompt.DialogTrigger className="MarkpromptFloatingTrigger">
              <AccessibleIcon.Root
                label={
                  trigger?.label !== undefined && trigger?.label !== null
                    ? trigger?.label
          ...
          <BaseMarkprompt.Portal>
            ...
            >
              <BaseMarkprompt.Title
                hide={
                  title?.hide !== undefined && title?.hide != null
                    ? title?.hide
                    : true
                }
              >
                {title?.text !== undefined && title?.text != null
                  ? title?.text
              ...
              {description?.text && (
                <BaseMarkprompt.Description
                  hide={
                    description?.hide !== undefined && description?.hide != null
                      ? description?.hide
                      : true
                  }
                >
          ...
          {close?.visible !== false && (
            ...
            >
              <BaseMarkprompt.Close className="MarkpromptClose">
                <AccessibleIcon.Root
                  label={
                    close?.label !== undefined && close?.label != null
                      ? close?.label
